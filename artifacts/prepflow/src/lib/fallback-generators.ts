...
export function getFallbackCodeExample(topic: string, approach: string = "optimalApproach"): any {
  ...
  // 13. DYNAMIC PROGRAMMING / DP / FIBONACCI / KNAPSACK / LCS
  if (lower.includes("dynamic programming") || lower.includes("dp") || lower.includes("fibonacci") || lower.includes("knapsack") || lower.includes("coin change") || lower.includes("lcs")) {
